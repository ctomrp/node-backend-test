...
export async function getPersonsService(req, res) {
  try {
...
export async function getPersonService(req, res) {
  try {
...
export async function createPersonService(req, res) {
  try {
    const {
      first_name,
      last_name,
...
export async function deletePersonService(req, res) {
  try {
...
export async function updatePersonService(req, res) {
  try {
    const { id } = req.params;
    const {
      first_name,
